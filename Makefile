...
cov-ci-no-ext: .develop
	@echo "Run without extensions"
	@AIOHTTP_NO_EXTENSIONS=1 PYTHONHASHSEED=0 pytest
cov-ci-aio-debug: .develop
	@echo "Run in debug mode"
	@PYTHONASYNCIODEBUG=1 PYTHONHASHSEED=0 pytest --cov-append
cov-ci-run: .develop
	@echo "Regular run"
	@PYTHONHASHSEED=0 pytest --cov-report=html --cov-append
